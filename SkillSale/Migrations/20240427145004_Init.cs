    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    FavoriteResumeId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FavoriteResumes", x => x.FavoriteResumeId);
                    table.ForeignKey(
                        name: "FK_FavoriteResumes_AspNetUsers_AuthorId1",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    FavoriteVacancyId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    AuthorId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    AuthorId1 = table.Column<string>(type: "nvarchar(450)", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FavoriteVacancies", x => x.FavoriteVacancyId);
                    table.ForeignKey(
                        name: "FK_FavoriteVacancies_AspNetUsers_AuthorId1",
                        column: x => x.AuthorId1,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FavoriteResumes_AuthorId1",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FavoriteVacancies_AuthorId1",
